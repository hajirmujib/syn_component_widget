...
import 'package:syn_common_widget/styles/style.dart';
import 'package:syn_common_widget/themes/themes.dart';

class CommonTextFormWithoutBorder extends StatelessWidget {
  const CommonTextFormWithoutBorder({
    Key? key,
    this.readOnly = false,
    this.enable = true,
                ...
                InputDecoration(
                  ...
                  enabledBorder: OutlineInputBorder(
                    ...
                    borderSide: BorderSide(
                      color: readOnly ? Colors.transparent : Colors.transparent,
                    ),
                  ),
